...
namespace Rws.LC.AppBlueprint.Interfaces
{
    ...
    public interface IAccountService
    {
        ...
        /// <returns></returns>
        Task SaveRegistrationInfo(RegisteredUpdatedEvent registeredEvent, CancellationToken cancellationToken);

        /// <summary>
        /// Updates the registration and installs to use the descriptorVersion 1.4.
        /// </summary>
        /// <param name="updatedEvent">The registered event.</param>
        /// <param name="cancellationToken">The cancellation token.</param>
        /// <returns></returns>
        Task UpdateToDescriptorVersion14(RegisteredUpdatedEvent updatedEvent, CancellationToken cancellationToken);
