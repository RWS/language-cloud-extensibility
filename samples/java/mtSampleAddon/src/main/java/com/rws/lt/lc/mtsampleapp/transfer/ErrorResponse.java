...
public class ErrorResponse {
    ...
    public static final String ALREADY_REGISTERED_CODE = "alreadyRegistered";
    ...
    public static final String ALREADY_REGISTERED_MESSAGE = "The Add-on has been already registered in LC";
