...
import com.rws.lt.lc.mtsampleapp.service.RemotePublicApiService;
...
import static com.rws.lt.lc.mtsampleapp.security.JWSExtractor.*;
...
public class JWSExtractorTest {
    ...
    private static final String MOCK_BASE_URL = "https://www.mt-sample-app.rws.com/";
    ...
    @Test
    public void extractJWS_appNameNotSetInContextForAudienceValidation_authExceptionThrownAndNoFieldsAreAddedToContext() throws Exception {
        DateTime now = DateTime.now();
        Map<String, Object> jwsHeaders = new LinkedHashMap<>();
        jwsHeaders.put(JWSExtractor.JWS_KID_HEADER, JWS_KEY_ID);
        jwsHeaders.put(JWSExtractor.JWS_ACCOUNT_ID_HEADER, TEST_ACCOUNT_ID);
