...
using Rws.LC.UISampleApp.DAL;
using Rws.LC.UISampleApp.Exceptions;
using Rws.LC.UISampleApp.Helpers;
using Rws.LC.UISampleApp.Interfaces;
using Rws.LC.UISampleApp.Services;
using System.Net;
using System.Text.Json;
using System.Text.Json.Serialization;

namespace Rws.LC.UISampleApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Set CORS based on settings
            var isCorsEnabled = Configuration.GetValue<bool>("Cors:Enable");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (isCorsEnabled)
            {
                var allowOrigins = Configuration.GetValue<string>("Cors:AllowOrigins");
                app.UseCors(options => options.WithOrigins(allowOrigins).AllowAnyHeader().AllowAnyMethod());
            }
