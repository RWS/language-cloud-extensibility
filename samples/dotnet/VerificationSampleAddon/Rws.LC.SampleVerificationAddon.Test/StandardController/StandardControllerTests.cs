...
using Rws.LC.SampleVerificationAddon.Test.Helpers;
using Rws.LC.SampleVerificationAddon.Controllers;
using System;
using System.IO;
using System.Linq;
using System.Text;
...
using Xunit;
using Rws.LC.SampleVerificationAddon;
...
namespace Rws.LC.AddonBlueprint.Test.StandardController
{
    public class StandardControllerTests
    {
        ...
        private SampleVerificationAddon.Controllers.StandardController BuildStandardController(HttpContext httpContext)
        {
            var standardControllerLogger = Substitute.For<ILogger<SampleVerificationAddon.Controllers.StandardController>>();

            var controller = new SampleVerificationAddon.Controllers.StandardController(_configuration, standardControllerLogger, _descriptorService, _accountService, _healthReporter)
            {
